...
@WebServlet(urlPatterns = {"/market/product-list/product-list.do", "/market/product-view/product-view.do", "/admin/product-register/product-register.do"})
public class ProductController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 관리자 - 상품등록 화면
		if (reqUri.endsWith("/admin/product-register/product-register.do")) {
			
			// 관리자 - 상품등록 페이지 요청
			RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin/product-register/product-register.jsp");
			dispatcher.forward(req, resp);
		}
